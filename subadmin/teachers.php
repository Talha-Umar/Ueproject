            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <?php 
                       ...
                       $k=0;
                       $sql="SELECT * FROM teachers WHERE d_id='$did'";
...
if(isset($_POST['edit'])){
  ...
  $sql = "UPDATE teachers SET name='$Name',d_id='$Department',contact='$Phone',email='$Email',address='$Address', password='$Password' WHERE id=$Id";
